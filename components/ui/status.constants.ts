...
export const API_STATUS_TO_HEBREW_MAP: Record<ApiStatus, string> = {
  ...
  [API_STATUSES.PREPARATION]: "בהכנה",
  [API_STATUSES.TOPPED_OUT]: "השלמת שלד",
  [API_STATUSES.APPROVED]: "מאושר",
  [API_STATUSES.PROPOSED]: "מוצע",
...
export const API_STATUS_ORDER: ApiStatus[] = [
  ...
  API_STATUSES.PREPARATION,
  API_STATUSES.APPROVED,
  API_STATUSES.PLANNED,
...
export const API_STATUS_MARKER_MAP: Record<ApiStatus, string> = {
  ...
  [API_STATUSES.PREPARATION]: "/mark2.png",       // Same as UNDER_CONSTRUCTION
  [API_STATUSES.APPROVED]: "/marker_logo.png",    // Same as PLANNED
...
export const API_STATUS_GRADIENT_MAP: Record<ApiStatus, string> = {
  ...
  [API_STATUSES.PREPARATION]: "bg-gradient-to-b from-[#FF6F61] to-[#FF007F]",     // Same as UNDER_CONSTRUCTION
  [API_STATUSES.APPROVED]: "bg-[#00A6A2]",                                        // Same as PLANNED
