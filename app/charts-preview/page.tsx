...
const DEMO_DATA = [
  {
    id: 1,
    project_name: "מגדל עזריאלי שרונה",
    city: "תל אביב",
    height_m: 238,
    floors: 61,
    tower_status: "הושלם",
