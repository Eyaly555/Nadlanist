    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <Card className="prose prose-invert md:prose-lg lg:prose-xl w-full prose-headings:text-black" dir="rtl" lang="he">
        <CardContent className="p-6 md:p-10">
          ...
          <p className="text-xl font-bold">1. כללי</p>
          <ul>
          ...
          <p className="text-xl font-bold">2. הצהרת אחריות בנוגע ל-AI</p>
          <ul>
          ...
          <p className="text-xl font-bold">3. אחריות מוגבלת</p>
          <ul>
          ...
          <p className="text-xl font-bold">4. פרטיות ואבטחת מידע</p>
          <ul>
          ...
          <p className="text-xl font-bold">5. שינויים ועדכונים</p>
          <ul>
          ...
          <p className="text-xl font-bold">6. דין וסמכות שיפוט</p>
          <ul>
          ...
          <p className="text-xl font-bold text-red-700">לתשומת ליבך:</p>
